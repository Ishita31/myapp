...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { colour: @bike.colour, fuel: @bike.fuel, image: @bike.image, kms: @bike.kms, model: @bike.model, name: @bike.name, user_id: @bike.user_id, year: @bike.year } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { colour: @bike.colour, fuel: @bike.fuel, image: @bike.image, kms: @bike.kms, model: @bike.model, name: @bike.name, user_id: @bike.user_id, year: @bike.year } }
